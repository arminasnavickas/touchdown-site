...
export default function ScheduleCard({
  ...
  time = "07:00 - 10:00",
  badge,
  // Optional larger treatment for a lead card in a section that wants one
  // event to read as the headline of the day (see Water Day Schedule,
  // where "Preparation" opens the day full-width above the rest) - taller
  // photo and a bigger title, same card otherwise.
  featured = false,
}: ScheduleCardData & { index: number; featured?: boolean }) {
