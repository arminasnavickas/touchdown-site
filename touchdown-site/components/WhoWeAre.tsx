...
export default function WhoWeAre({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-xl flex-col gap-10">
      ...
      <Reveal delay={150} className="flex flex-1">
        <button
          type="button"
          onClick={() => openLightbox([image], 0)}
          className="relative z-10 h-[500px] w-full flex-1 cursor-zoom-in md:h-[660px]"
